...
export const createCourse = async (req, res) => {
    try {
        if (!req.body.name || !req.body.description || !req.body.features || !req.body.price || !req.body.duration || !req.body.discountPrice || !req.body.earlyBirdTitle || !req.body.courseTotalDuration) {
